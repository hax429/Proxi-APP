...
/**
 * HomeView - Main Dashboard and Home Screen
 *
 * This is the primary dashboard screen for the Proxi application, serving as
 * the main entry point and overview for users. It provides quick access to
 * key features and displays important information at a glance.
 *
 * ## Responsibilities:
 ...
 * - Status indicators for device connections
 ...
 *
 * ## Integration:
 * - Works with BLEManager for device status
 * - Integrates with UserManager for profile data
 * - Uses FriendsManager for social features
